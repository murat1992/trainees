...
namespace Dev\Mymodule\IBlockProp\Types;
...
class ComplexType
{
    ...
    public static function GetUserTypeDescription()
    {
        return array(
            'PROPERTY_TYPE' => 'S',
            'USER_TYPE' => 'USER_COMPLEX_TYPE',
            'DESCRIPTION' => getMessage('MYMOD_CPROP_DESC'),
    ...
    public static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        if(!empty($arProperty['USER_TYPE_SETTINGS'])){
            ...
            return '<span>'.getMessage('MYMOD_CPROP_ERROR_INCORRECT_SETTINGS').'</span>';
        }
    ...
    public static function GetSettingsHTML($arProperty, $strHTMLControlName, &$arPropertyFields)
    {
        $arPropertyFields = array(
            'USER_TYPE_SETTINGS_TITLE' => getMessage('MYMOD_CPROP_SETTINGS_TITLE'),
                        ...
                        <td>
                            <table class="mf-img-table">
                                <tr>
                                    <td>'.$content.'<br>
                                        <div>
                                            <label><input name="'.$strHTMLControlName['VALUE'].'['.$code.'][DEL]" value="Y" type="checkbox"> '. getMessage("MYMOD_CPROP_FILE_DELETE") . '</label>
